...
### Advance Folder
    ...
    5. Hit Save then Ok. 
        (you can still edit other kanji by editing the kanji start, kanji count 
            then hit show -> then edit and save.)
    6. Hit Export if you are ready to save all the edited meanings.
            (the edited meanings will start to download as kanjidata.js)
